...
async function main() {
  ...
  try {
    await JSONLoader.loadMultiple(['characters', 'radicals', 'idioms', 'polyphones', 'pokedex_series'])
    console.log('[App] Step 3 完成：JSONLoader.loadMultiple([characters, radicals, idioms, polyphones, pokedex_series])')
  } catch (err) {
