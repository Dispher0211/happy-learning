...
async function main() {
  ...
  try {
    await JSONLoader.loadMultiple(['characters', 'radicals', 'idioms', 'polyphones'])
    console.log('[App] Step 3 完成：JSONLoader.loadMultiple([characters, radicals, idioms, polyphones])')
  } catch (err) {
